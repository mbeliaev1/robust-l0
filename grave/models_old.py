...
cfg = {
    'mlp': [64, 'M', 128, 'M', 256, 256, 'M', 512, 512, 'M', 512, 512, 'M'],
    'cnn': [64, 'M', 128, 'M', 256, 256, 'M', 512, 512, 'M', 512, 512, 'M'],
...
class C_Net(nn.Module):
    '''
    Convolutional NN with same structure as Distillation Defense
    NOTE softmax is not used at the output as nn.CrossEntropyLoss()
         takes care of this.
    '''
    def __init__(self):
...
class C_Net_eval(nn.Module):
    ...
    '''
    def __init__(self, mu, sigma):
        super(C_Net_eval, self).__init__()
        self.conv1 = nn.Conv2d(1,32,3)
        self.conv2 = nn.Conv2d(32,32,3)
        self.conv3 = nn.Conv2d(32,64,3)
        self.conv4 = nn.Conv2d(64,64,3)
...
class r_C_Net_eval(nn.Module):
    ...
    '''
    def __init__(self):
        super(r_C_Net_eval, self).__init__()
        self.conv1 = nn.Conv2d(1,32,3)
        self.conv2 = nn.Conv2d(32,32,3)
        self.conv3 = nn.Conv2d(32,64,3)
        self.conv4 = nn.Conv2d(64,64,3)
